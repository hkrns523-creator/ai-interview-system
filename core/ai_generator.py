...
"Cybersecurity Analyst": {
    ...
    "hard": [
        {
            "question": "How do you respond to a cyber security incident?",
            "difficulty": "Hard",
...
def generate_questions(
    ...
    easy_questions = role_questions.get(
        "easy",
        []
    )

    medium_questions = role_questions.get(
        "medium",
        []
    )

    hard_questions = role_questions.get(
        "hard",
        []
    )
